...
export const baseURL = 'https://girirajtrading.booksica.in/api/'
export const http2 = 'https://girirajtrading.booksica.in/'

const http = axios.create({
	baseURL: 'https://girirajtrading.booksica.in/api/',
	timeout: 100000,
	headers: {
